...
import com.mobius.software.mqttsn.parser.packet.impl.Pubrec;
...
public class PubrecTests
{
	...
	private static Pubrec message;

	@BeforeClass
	public static void beforeClass()
	{
		message = new Pubrec(MESSAGE_ID);
	}
